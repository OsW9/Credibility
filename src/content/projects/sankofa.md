...
proofs: [
  {
    type: "CaseStudy",
    url: "https://github.com/OsW9/Credibility",
    label: "Référentiel d'Architecture TOGAF"
  }
]
---
...
2. **Structuration** : Cartographier les connaissances à travers des graphes et référentiels linguistiques.
3. **Souveraineté** : Assurer la gouvernance éthique et la subsidiarité patrimoniale des données.

### Modèle en 5 Couches (Cible)
* **Couche 5 : Services de transmission & valorisation** — Éducation, recherche, IA responsable assistée.
* **Couche 4 : Services de connaissance** — Graphes, taxonomies, traductions et gestion des variantes.
* **Couche 3 : Gouvernance patrimoniale** — Validation communautaire/scientifique et classification de sensibilité.
* **Couche 2 : Patrimoine numérique** — Archivage des originaux et gestion des métadonnées de provenance.
* **Couche 1 : Sources patrimoniales** — Détenteurs physiques, communautés et institutions partenaires.
